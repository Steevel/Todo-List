...
exports.editTask = async (req, res) => {
    ...
    try {
        ...
        const editedTask = req.body.updatedtask;
...
exports.search = async (req, res) => {
    console.log('Searching Todo/Task', req.query.q)
    ...
    try {
        ...
        const searchResult = await Todo.find({ $or: [{ title: new RegExp(query, 'i') }, { tasks: new RegExp(query, 'i') }] })
